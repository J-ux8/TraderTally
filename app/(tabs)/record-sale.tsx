...
import { ArrowLeft, Calendar as CalendarIcon, Check, ChevronDown, Plus, ShoppingBag } from "lucide-react-native";
...
export default function RecordSaleScreen() {
  ...
  const { categories: contextCategories, addTransaction, updateTransaction, removeTransaction, refreshCategories, addCategory, recordSale } = useTransactionsContext();
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      const result = await recordSale(numericAmount, selectedCategory, description.trim() || null, dateStr);
      
      // Replace optimistic transaction with the returned local record
      if (result) {
    ...
    <SafeAreaView style={[styles.safeArea, { backgroundColor: colors.backgroundColor }]} edges={['top']}>
      ...
      >
        ...
        <View style={styles.card}>
          <Text style={styles.label}>Amount received (ZMW)</Text>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.categoryWrapper}>
            ...
            activeOpacity={0.7}
            >
              <Text style={[styles.categoryButtonText, !selectedCategoryName && styles.categoryButtonPlaceholder]}>
            ...
            {showCategoryDropdown && (
              ...
              >
                ...
                >
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      ...
                      setShowCategoryDropdown(false);
                          ...
                          activeOpacity={0.7}
                  >
                          <Text style={[styles.categoryOptionTextMuted, { color: colors.textSecondary }]}>No category</Text>
                  </TouchableOpacity>
                    ...
                    <TouchableOpacity
                      ...
                      onPress={() => {
                        ...
                        setShowCategoryDropdown(false);
                            ...
                            activeOpacity={0.7}
                    >
                            <Text style={[styles.categoryOptionText, { color: colors.textColor }]}>{category.name}</Text>
                  ...
                  {/* Add new category */}
                        <View style={[styles.categoryDivider, { backgroundColor: colors.borderColor }]} />
                  {isAddingCategory ? (
                    <View style={styles.addCategoryInputContainer}>
                      <TextInput
                              style={[styles.addCategoryInput, { color: colors.textColor, backgroundColor: colors.inputBackground, borderColor: colors.borderColor }]}
                    ...
                    >
                            ...
                            <Text style={[styles.addCategoryTriggerText, { color: colors.textColor }]}>Add new category</Text>
                    </TouchableOpacity>
                  )}
                      </ScrollView>
                </View>
        ...
        <View style={[styles.card, { backgroundColor: colors.cardBackground }]}>
          ...
          <TextInput
            ...
            placeholder="e.g., 2 crates of drinks, customer John"
            placeholderTextColor={colors.textSecondary}
            multiline
            numberOfLines={3}
          ...
          <View style={styles.modalContent}>
            ...
            <View style={styles.quickDateContainer}>
              <TouchableOpacity
                ...
                activeOpacity={0.7}
              >
                <Text style={[styles.quickDateText, isToday && styles.quickDateTextActive]}>Today</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[styles.quickDateButton, isYesterday && styles.quickDateButtonActive]}
                onPress={() => {
                  const yesterday = new Date();
                  yesterday.setDate(yesterday.getDate() - 1);
                  setDate(yesterday);
                ...
                activeOpacity={0.7}
              >
                <Text style={[styles.quickDateText, isYesterday && styles.quickDateTextActive]}>Yesterday</Text>
              </TouchableOpacity>
            </View>
