      ...
      <ScrollView style={dynamicStyles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.section}>
            ...
            <TouchableOpacity
              style={dynamicStyles.settingItem}
              onPress={() => handleOpenUrl('https://tradertally.app/terms')}
              activeOpacity={0.7}
            >
              <View style={styles.settingLeft}>
                <View style={styles.settingIcon}>
            ...
            <TouchableOpacity
              style={dynamicStyles.settingItem}
              onPress={() => handleOpenUrl('https://tradertally.app/privacy')}
              activeOpacity={0.7}
            >
              <View style={styles.settingLeft}>
                <View style={styles.settingIcon}>
          ...
          <View style={styles.footer}>
            <Text style={[styles.footerText, { color: textSecondary }]}>TraderTally Version 1.0.0</Text>
          </View>
        </View>
      </ScrollView>
            ...
            <ScrollView style={dynamicStyles.modalScroll}>
              {legalModalType === 'terms' ? (
                <View style={styles.legalContent}>
                  ...
                  <Text style={[styles.legalText, { color: textSecondary }]}>By using TraderTally, you agree to these terms. TraderTally is a record-keeping tool for small businesses and independent traders.</Text>
                  
                  <Text style={[styles.legalTitle, { color: textColor }]}>2. User Accounts</Text>
                  <Text style={[styles.legalText, { color: textSecondary }]}>You are responsible for maintaining the confidentiality of your account credentials. TraderTally is not liable for any loss resulting from unauthorized access to your account.</Text>
                  
                  <Text style={[styles.legalTitle, { color: textColor }]}>3. Data Ownership</Text>
                  <Text style={[styles.legalText, { color: textSecondary }]}>You retain all ownership rights to the data you enter. By using the sync feature, you authorize TraderTally to store this data on our secure cloud servers.</Text>
                  
                  <Text style={[styles.legalTitle, { color: textColor }]}>4. Limitation of Liability</Text>
                  <Text style={[styles.legalText, { color: textSecondary }]}>TraderTally is provided "as is" without warranties of any kind. We are not responsible for any financial errors or business losses resulting from the use of the application.</Text>
                </View>
              ) : (
                <View style={styles.legalContent}>
                  <Text style={[styles.legalTitle, { color: textColor }]}>1. Information Collection</Text>
                  <Text style={[styles.legalText, { color: textSecondary }]}>We collect your email address and profile information (name, business type) to provide and improve the TraderTally service.</Text>
